...
describe('Company', () => {
  describe('.ctor()', () => {
    test('correctly initializes the object', () => {
      ...
      let company = new Company(id, name, address, registrationInfo, financialStatements);
  ...
  describe('#toDto() and .fromDto()', () => {
    test('map correctly to and from DTO object', () => {
      let company = new Company(12345, 'M-Tel', 'Some address', new RegistrationInfo(1, Date.now(), 'Sud'), [
